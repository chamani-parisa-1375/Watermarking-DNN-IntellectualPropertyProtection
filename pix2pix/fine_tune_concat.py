...
runs = 'runs2'
dataset_path = rf'datasets\sub_gray_dataset'
batch_size = 32
imgsize=(256, 256)
join_img = True
num_epochs = 20
...
resume = False
model_path = rf'runs2\watermark_cocat/uni_256_binary_2'
...
if resume:
    ...
    save_result = os.path.join(runs,'fine_tune_cancat',split[-1])
    temp = save_result
    i= 1
    while True:
...
def main():
    ...
    G_model,G_optimizer = fine_tune_model(G_model,number_of_freezlayer)
